...
(function() {
    ...
    var login_id_input                 = login_button.closest("form").querySelector('input[name="id"]');
    ...
    var register_username_input        = register_button.closest("form").querySelector('input[name="username"]');
    ...
    login_button.addEventListener("click", (e) => {
        ...
        if (form.checkValidity()) {
			...
			if (login_id_input.value == "" || login_password_input.value == "") {
    ...
    register_button.addEventListener("click", (e) => {
        ...
        if (form.checkValidity()) { 
            ...
            if (register_email_input.value           == "" || register_username_input.value        == "" || 
            	register_password_input.value        == "" || register_repeat_password_input.value == "") {
            ...
            sendToServer(form, register_warning_div, 'SignUp', false);
